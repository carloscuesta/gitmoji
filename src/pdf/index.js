...
function generatePDF() {
  ...
  for (var i = 0; i < emojiList.length; i++) {
    ...
    var x =
      layout.leftMargin +
      (Math.floor(i / layout.emojisHigh) % 2) * layout.secondMargin;
    ...
    doc.image(__root + 'dist/pdf/emojis/' + emoji.name + '.png', x, y, {
    ...
    doc
      ...
      .text(
        emoji.description,
        x + layout.textLeftMargin,
        y + layout.textDescTopMargin
      );
  }
