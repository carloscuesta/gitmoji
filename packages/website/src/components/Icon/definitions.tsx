export const IconDefinitions = () => (
  ...
  >
    <defs>
      ...
      <symbol id="icon-star-fill" x="0px" y="0px" viewBox="0 0 800 800">
        <title>star fill</title>
        <path
          fill="#ffdd67"
          d="M438.6,41.5l90.2,182.8c6.3,12.7,18.4,21.5,32.4,23.6l201.8,29.3c35.3,5.1,49.4,48.6,23.9,73.5L641,493
	...
	c14-2,26.2-10.8,32.4-23.6l90.2-182.8C377.2,9.5,422.8,9.5,438.6,41.5z"
      ...
      <symbol id="icon-star" x="0px" y="0px" viewBox="0 0 800 800">
        <title>star</title>
        <path
          d="M787,350.7c25.6-24.9,11.5-68.3-23.9-73.5l-201.8-29.3c-14-2-26.2-10.8-32.4-23.6L438.6,41.5
	c-15.8-32-61.5-32-77.2,0l-90.2,182.8c-6.3,12.7-18.4,21.5-32.4,23.6L36.9,277.2c-35.3,5.1-49.4,48.5-23.9,73.5l146,142.3
	c10.1,9.9,14.8,24.2,12.4,38.1l-34.5,201c-6,35.2,30.9,62,62.5,45.4L380,682.6c12.5-6.6,27.6-6.6,40.1,0l180.5,94.9
	c31.6,16.6,68.6-10.2,62.5-45.4l-34.5-201c-2.4-14,2.2-28.2,12.4-38.1L787,350.7z M577.6,428c-31.6,30.8-45.9,75.1-38.5,118.5
	l18.1,105.8l-95-50C443.1,592.3,421.6,587,400,587c-21.6,0-43.1,5.3-62.2,15.3l-95.1,50l18.2-105.9c7.5-43.4-6.9-87.6-38.5-118.4
	l-76.9-75l106.3-15.4c43.6-6.3,81.2-33.7,100.7-73.2l47.5-96.3l47.5,96.3c19.5,39.5,57.2,66.9,100.8,73.2l106.2,15.4L577.6,428z"
        />
      </symbol>
