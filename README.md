...
- [`espanso-gitmojis`](https://github.com/Lyokolux/espanso-gitmojis): A [package](https://hub.espanso.org/packages/gitmojis/) to expand Gitmoji codes into emojis with [espanso](https://espanso.org/).
